//
//  PlaceholderDetailTableViewController.m
//  PlaceReminder
//
...
@interface PlaceholderDetailTableViewController ()
...
@implementation PlaceholderDetailTableViewController
...
- (void)viewDidLoad {
    ...
    // registrazione per le notifiche in modo da shiftare la ui coperta dalla tastiera
...
//
//- (void)keyboardWillHide:(NSNotification *)notification {
//    // Ripristina la posizione originale dell'interfaccia utente
//    [UIView animateWithDuration:0.3 animations:^{
//        CGRect f = self.view.frame;
//        f.origin.y = 0.0f;
//        self.view.frame = f;
